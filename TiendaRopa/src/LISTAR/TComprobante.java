...
import EntornoGrafico.EmisionComprobante;
import EntornoGrafico.NuevaCategoria;



public class TComprobante extends javax.swing.JFrame {
    ...
    public TComprobante() {
        ...
        modelo.addColumn("codigo Comprobante");
    ...
    try{
        ...
        obj.abrirOracle();
        obj.rs=obj.ts.executeQuery("select * from comprobante_pago");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TComprobante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TComprobante().setVisible(true);
            }
        });
    }
