...
import EntornoGrafico.NuevoProveedor;



public class TProveedro extends javax.swing.JFrame {
    ...
    try{
        ...
        obj.abrirOracle();
        obj.rs=obj.ts.executeQuery("select * from proveedor ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TProveedro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TProveedro().setVisible(true);
            }
        });
    }
