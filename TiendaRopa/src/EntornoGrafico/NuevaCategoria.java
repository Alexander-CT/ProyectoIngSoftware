...
this.setLocation(50,100);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        CategoriaI in=new CategoriaI();
        in.setCod_cate(txtCodigo.getText());
        in.setNom_cate(txtNombre.getText());
        
        ServicioCategoria s =new ServicioCategoria();
        
        boolean x=s.agregarCategoriaNueva(in);
   ...
   ServicioCategoria ps=new ServicioCategoria();
      CategoriaI data=ps.buscarCategoriaPorCodigo1(cod);
               
        if(data!=null)
        {
           
        txtCodigo.setText(data.getCod_cate());
        txtNombre.setText(data.getNom_cate());
    ...
    // End of variables declaration//GEN-END:variables
        ...
        CategoriaMetodos insta = new CategoriaMetodos();
